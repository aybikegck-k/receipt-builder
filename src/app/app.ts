    ...
    this.receiptService
      ...
      .subscribe({
        next: (data: ReceiptData) => {
          ...
          console.log(
            'Adisyon verileri service üzerinden yüklendi:',
            this.receiptData
          );
        },
...
getDiscount(): number {
  return this.calculationService.getDiscount(
    this.getSubTotal(),
...
getAmountAfterDiscount(): number {
  return this.calculationService.getAmountAfterDiscount(
    this.getSubTotal(),
    this.getDiscount()
  );
}
...
getVat(): number {
  return this.calculationService.getVat(
...
getTotal(): number {
  return this.calculationService.getTotal(
    this.getSubTotal(),
    this.getDiscount(),
    this.getVat()
  );
